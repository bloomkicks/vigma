...
/* harmony import */ var _Section_module_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2922);
...
__webpack_require__.d(__webpack_exports__, {
  "J": () => (/* binding */ translateCategory),
  "k": () => (/* binding */ translateQuestion)
});
...
var Footer_module = __webpack_require__(9873);
...
var NavLink_module = __webpack_require__(549);
...
var Header_module = __webpack_require__(8421);
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("header", {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        isActiveNav ? /*#__PURE__*/ jsx_runtime_.jsx("img", {
                            src: crossSvg,
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(external_react_redux_.Provider, {
                store: src_store,
                children: /*#__PURE__*/ jsx_runtime_.jsx(layout_ThemeProvider, {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "bd": () => (/* binding */ categories),
  "JZ": () => (/* binding */ quizActions),
  "$d": () => (/* binding */ quizReducer)
});
...
/* harmony default export */ const categories_kitchen = (kitchen);

;// CONCATENATED MODULE: ./src/data/quiz/categories/closet.ts
const closet_gift = (/* unused pure expression or super */ null && ([
    "Сковорода",
    "Смеситель",
    "Набор Ножей"
]));
...
/* harmony default export */ const categories_closet = (closet);

;// CONCATENATED MODULE: ./src/data/quiz/categories/childish.ts
const childish_gift = (/* unused pure expression or super */ null && ([
    "Сковорода",
    "Смеситель",
    "Набор Ножей"
]));
...
/* harmony default export */ const categories_childish = (childish);

;// CONCATENATED MODULE: ./src/data/quiz/categories/bathroom.ts
const bathroom_gift = (/* unused pure expression or super */ null && ([
    "Сковорода",
    "Смеситель",
    "Набор Ножей"
]));
...
/* harmony default export */ const categories_bathroom = (bathroom);

;// CONCATENATED MODULE: ./src/data/quiz/categories/shop.ts
const shop_gift = (/* unused pure expression or super */ null && ([
    "Сковорода",
    "Смеситель",
    "Набор Ножей"
]));
...
/* harmony default export */ const categories_shop = (shop);

;// CONCATENATED MODULE: ./src/data/quiz/categories/office.ts
const office_gift = (/* unused pure expression or super */ null && ([
    "Сковорода",
    "Смеситель",
    "Набор Ножей"
]));
...
/* harmony default export */ const categories_office = (office);
...
[
    ...
    categories_shop,
    categories_office
].forEach((category)=>category.push(...[
        {
            front: frontOptions
        },
        {
...
/* harmony default export */ const category_questions = (allCategoryQuestions);
...
/* harmony default export */ const next_question = (nextQuestion);
...
/* harmony default export */ const quiz_reducers_clear = (clear);
...
/* harmony default export */ const set_connect_way = (setConnectWay);
...
function toggleSelectOption(state, action) {
    ...
    const selectedIndex = state.selectedOptions.findIndex((answ)=>answ === selectedOption);
    if (selectedIndex !== -1) {
        state.selectedOptions = [];
    } else {
        state.selectedOptions = [
...
/* harmony default export */ const toggle_select_option = (toggleSelectOption);
...
/* harmony default export */ const previous_question = (previousQuestion);
...
function selectConstructorOption(state, action) {
    ...
    if (question !== "microwave") {
        const microwave = getIsMicrowaveVisible() ? constructorQuestions["microwave"] || null : undefined;
        constructorQuestions["microwave"] = microwave;
    }
}
/* harmony default export */ const select_constructor_option = (selectConstructorOption);
...
/* harmony default export */ const select_item = (selectItem);
...
const quizSlice = (0,toolkit_.createSlice)({
    name: "quiz",
    initialState,
    reducers: {
...
var __webpack_exports__ = (__webpack_exec__(8503));
