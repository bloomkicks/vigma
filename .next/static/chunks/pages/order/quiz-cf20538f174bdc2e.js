...
// EXTERNAL MODULE: ./src/components/order/OrdersTitle.module.css
var OrdersTitle_module = __webpack_require__(8613);
...
var OrderSection = function(props) {
    ...
    var valueCond = !curParams.has("bundle") && !isFurther && curParams.has("category") && curParams.get("shape") !== "current" && curParams.get("front") !== "current" && curParams.get("body") !== "current" && curParams.get("table") !== "current";
    var valueRes = order_translations/* default */.Z[curParams.get(name)] || curParams.get(name) || "Не Выбрано";
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                ...
                children: custom ? /*#__PURE__*/ (0,jsx_runtime.jsx)("input", {
                    ...
                    children: [
                        ...
                        value && /*#__PURE__*/ (0,jsx_runtime.jsx)("b", {
                            children: value
                        })
                    ]
                })
...
var orderTranslations = (_obj = {
    ...
    tape: "МДФ Плёнка",
    massive: "Массив"
}, _defineProperty(_obj, "ldsp", "ЛДСП"), _defineProperty(_obj, "egger", "ЛДСП Egger"), _defineProperty(_obj, "dsp", "ДСП"), _defineProperty(_obj, "stone-acryl", "Искуственный Акрил"), _defineProperty(_obj, "troya", "ДСП Троя"), _defineProperty(_obj, "agra", "ДСП Агра"), _defineProperty(_obj, "quartz", "Искуственный Кварц"), _defineProperty(_obj, "custom", "Ваш Вариант"), _obj);
...
// extracted by mini-css-extract-plugin
module.exports = {"OrdersTitle":"OrdersTitle_OrdersTitle__wcMF3","Arrow":"OrdersTitle_Arrow__xAPeO"};
