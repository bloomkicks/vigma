...
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/works",
      function () {
        return __webpack_require__(2558);
      }
    ]);
    if(false) {}
...
// EXTERNAL MODULE: ./src/components/works/ZoomedImage.js
var works_ZoomedImage = __webpack_require__(2171);
...
var ImageContainer_ImageContainer = function(props) {
    var photos = props.photos, containerProps = _objectWithoutProperties(props, [
        "photos"
    ]);
    var ref = useState(null), zoomedSrc = ref[0], setZoomedSrc = ref[1];
    var zoomClickHandler = function(e) {
        e.stopPropagation();
        var src = e.target.getAttribute("src");
        if (zoomedSrc == src) setZoomedSrc(null);
    };
    var zoomFocusHandler = function(e) {
        var src = e.target.getAttribute("src");
        if (zoomedSrc == src) setZoomedSrc(null);
        setZoomedSrc(src);
    };
    var zoomBlurHandler = function(e) {
        var src = e.target.getAttribute("src");
        console.log(src);
        if (zoomedSrc == src) {
            setZoomedSrc(null);
    ...
    return(/*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsx("div", {
                ...
                children: photos.map(function(photo, index) {
                    return(/*#__PURE__*/ _jsx("div", {
                        className: "\n              ".concat(photo.isVertical ? classes.Vertical : classes.Horiz, "\n            "),
            ...
            zoomedSrc && /*#__PURE__*/ _jsx(ZoomedImage, {
                src: zoomedSrc
            }, Math.random())
        ]
    }));
};
/* harmony default export */ var works_ImageContainer = ((/* unused pure expression or super */ null && (ImageContainer_ImageContainer)));

// EXTERNAL MODULE: ./src/components/ui/MainButton.js
var ui_MainButton = __webpack_require__(834);
// EXTERNAL MODULE: ./src/components/ui/Secondary.js
var ui_Secondary = __webpack_require__(2276);
// EXTERNAL MODULE: ./src/components/ui/Section.js
var ui_Section = __webpack_require__(4568);
...
var Work = function(props) {
    var photos = props.photos, colors = props.colors, query = props.query, description = props.description, name = props.name, style = props.style, deskStyle = props.deskStyle, imgContainerStyle = props.imgContainerStyle;
    var router = useRouter();
    var searchParams = new URLSearchParams(query);
    var orderHandler = function(e) {
        router.push("/order?".concat(searchParams));
    };
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    /*#__PURE__*/ _jsxs("figcaption", {
                        className: classes.DescSec,
                        children: [
                            /*#__PURE__*/ _jsx(Secondary, {
                                children: name
                            }),
                            description.map(function(descrip) {
...
/* harmony default export */ var works_Work = ((/* unused pure expression or super */ null && (Work)));
