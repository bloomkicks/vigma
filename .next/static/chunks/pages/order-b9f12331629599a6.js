...
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/order",
      function () {
        return __webpack_require__(3997);
      }
    ]);
    if(false) {}
...
var TotalOrderForm = function(props) {
    ...
    var orderHandler = _asyncToGenerator(runtime_default().mark(function _callee(e) {
        var email, name, number, comment, isNameValid, isEmailValid, isNumberValid, isFormValid, clientInfo, orderInfo, emailParams;
        return runtime_default().wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 13:
                    ...
                    orderInfo = props.orderInfo.map(function(info) {
                        return info.actual;
                    });
...
var TotalOrderTree = function(props) {
    var orderInfo = props.orderInfo, item = props.item, treeProps = TotalOrderTree_objectWithoutProperties(props, [
        "orderInfo",
        "item"
    ]);
    if (item) {
        return(/*#__PURE__*/ (0,jsx_runtime.jsx)(Secondary/* default */.Z, {
            className: (TotalOrderTree_module_default()).work,
            children: item
        }));
    }
    return(/*#__PURE__*/ (0,jsx_runtime.jsx)(Section/* default */.Z, {
        className: (TotalOrderTree_module_default()).tree,
        children: orderInfo.map(function(info) {
            if (info.property) return(/*#__PURE__*/ (0,jsx_runtime.jsxs)("p", {
                children: [
...
var TotalOrderPage = function(props) {
    var translate = function translate(word) {
        return order_translations/* default */.Z[router.query[word]] || router.query[word];
    };
    var router = (0,next_router.useRouter)();
...
// extracted by mini-css-extract-plugin
module.exports = {"Query":"TotalOrderTree_Query__g2Eqs","tree":"TotalOrderTree_tree__VPY4x","work":"TotalOrderTree_work__TuvRF"};
