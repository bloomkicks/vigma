...
const PrivacyPage = () => {
  return (
    <Box
      ...
      sx={{ "& > h3": { mb: 1 }, "& > p": { mb: 3 } }}
    >
      <Typography variant="h2" mb={5} textAlign="center" px={2}>
        Политика в отношении обработки персональных данных
      </Typography>
      <Typography variant="h3">1. Общие положения</Typography>
      <Typography>
        ...
        безопасности персональных данных, предпринимаемые ИП Филатов Михаил
        Юрьевич (далее — Оператор). 1.1. Оператор ставит своей важнейшей целью и
      ...
      <Typography>
        ...
        https://vigmamebel.ru. 2.4. Информационная система персональных данных —
        ...
        определяемому Пользователю веб-сайта https://vigmamebel.ru. 2.9.
        ...
        https://vigmamebel.ru. 2.11. Предоставление персональных данных —
      ...
      <Typography variant="h3">3. Основные права и обязанности</Typography>
      <Typography>
        Оператора 3.1. Оператор имеет право: — получать от субъекта персональных
        ...
        о персональных данных или другими федеральными законами. 3.2. Оператор
      ...
      <Typography>
        ...
        справедливой основе. 5.2. Обработка персональных данных ограничивается
        ...
        персональных данных. 5.3. Не допускается объединение баз данных,
        содержащих персональные данные, обработка которых осуществляется в
        целях, несовместимых между собой. 5.4. Обработке подлежат только
        ...
        персональных данных по отношению к заявленным целям их обработки. 5.6.
        ...
        уточнению неполных или неточных данных. 5.7. Хранение персональных
      ...
      <Typography>
        Цель обработки уточнение деталей заказа Персональные данные фамилия,
        имя, отчество номера телефонов Правовые основания Федеральный закон «Об
        информации, информационных технологиях и о защите информации» от
        27.07.2006 N 149-ФЗ Виды обработки персональных данных Запись
        персональных данных для связи
      </Typography>
      <Typography variant="h3">
      ...
      <Typography>
        ...
        персональных данных на обработку его персональных данных. 7.2. Обработка
        ...
        и свободы субъекта персональных данных. 7.6. Осуществляется обработка
      ...
      <Typography>
        ...
        лицу для исполнения обязательств по гражданско-правовому договору. 8.3.
        ...
        уведомление на адрес электронной почты Оператора vigmaspb@gmail.com с
        ...
        Оператора vigmaspb@gmail.com с пометкой «Отзыв согласия на обработку
        ...
        выгодоприобретателем или поручителем по которому является субъект
        персональных данных. 8.9. Условием прекращения обработки персональных
      ...
      <Typography>
        ...
        блокирование, удаление и уничтожение персональных данных. 9.2. Оператор
      ...
      <Typography>
        ...
        персональных данных). 10.2. Оператор до подачи вышеуказанного
        уведомления, обязан получить от органов власти иностранного государства,
        иностранных физических лиц, иностранных юридических лиц, которым
        планируется трансграничная передача персональных данных, соответствующие
        сведения.
      </Typography>
      <Typography variant="h3">
      ...
      <Typography variant="h3">12. Заключительные положения</Typography>
      <Typography>
        ...
        Оператору с помощью электронной почты vigmaspb@gmail.com. 12.2. В данном
