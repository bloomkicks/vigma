...
const PrivacyPage = () => {
  return (
    <>
      <MetaHead title={privacyTitle} description={privacyDescription} />
      <main className="privacy-page section-light !pt-[128px]">
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://vigmamebel.ru.
        </p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://vigmamebel.ru. <br />
          ...
          2.10. Пользователь — любой посетитель веб-сайта https://vigmamebel.ru.{" "}
          <br />
        ...
        <p>
          ...
          имя, отчество номера телефонов Правовые основания Федеральный закон
        ...
        <p>
          ...
          vigmaspb@gmail.com с пометкой «Актуализация персональных данных».{" "}
          <br />
          ...
          на электронный адрес Оператора vigmaspb@gmail.com с пометкой «Отзыв
        ...
        <p>
          ...
          осуществлять обработку персональных данных). <br />
        ...
        <p>
          ...
          Оператору с помощью электронной почты vigmaspb@gmail.com. <br />
          ...
          сети Интернет по адресу https://vigmamebel.ru/privacy.html.
        </p>
      </main>
      <ModalRoot />
    </>
