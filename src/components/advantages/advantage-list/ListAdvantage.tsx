...
let advantages = [
  {
    ...
    description: "Наши мастера делают качественную мебель в короткие сроки",
  },
  {
  ...
  },
  {
    ...
    description:
      "Гарантированный дизайн-проект поможет найти оптимальное решение для вашего интерьера",
  },
];
