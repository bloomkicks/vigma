...
let advantages = [
  {
    ...
    description:
      "Мы работаем на собственном производстве с современным оборудованием. Средний срок изготовления кухни за 2022 год — 14 дней",
    imgName: "saw.png",
  },
  {
    title: "Работа по договору",
    description:
      "Соблюдение сроков и условий договора очень важно для нас. Расчёт принимается частями: по карте, наличными или через расчетный счёт",
  ...
  },
  {
    ...
    description:
      "Бесплатная установка и подключение техники на кухне (плита, посудомоечная машина и др.)",
    imgName: "dishwasher.png",
  },
  {
    title: "Доставка и установка",
    description:
      "Осуществляем доставку за день по всему Санкт-Петербургу и Лен. области",
    imgName: "package.png",
  },
];
