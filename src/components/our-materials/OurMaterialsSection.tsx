...
const OurMaterialsSection = () => {
  const { curIndex, moveRightHandler, isLaptop, isMedium, isExSmall } =
    useSlider(materials.length, true);

  let materialWidth = isLaptop ? 975 : isMedium ? 440 : isExSmall ? 295 : 305;

  return (
    <section
      id="our-materials"
      className="section-dark !px-0 md:!px-[120px] lg:!px-[202px]"
    >
      <h2 className="heading mb-2.5 lg:mb-8 mx-[35px] lg:mx-0 xs:mx-8">
        Наши кухни сохраняют первозданные вид и функциональность от 10 лет и
        более
      </h2>
      <p className="ml-[35px] xs:ml-8 mr-[42px] mb-8 leading-[1.5] lg:mb-[60px] max-w-[900px] lg:!mx-auto">
        Благодаря сертифицированным и качественным материалам, которые мы
        тщательно подбираем под каждую кухню
      </p>
